        ...
        <ViewThemed style={{...globalStyles.container}}>
            ...
            >
                <MaterialTopTabs.Screen
                    name="all-book"
                    options={{
                        tabBarLabel:  t('more.all_book'),
                        title:  t('more.all_book'),
                        tabBarLabelStyle: {
                            textTransform: 'none',
                            fontSize: 15,
                            fontWeight: '700',
                ...
                <MaterialTopTabs.Screen
                    name="borrowing"
                    options={{
                        tabBarLabel: t('more.my_borrowings'),
                        title: t('more.my_borrowings'),
                        tabBarLabelStyle: {
                            textTransform: 'none',
                            fontSize: 15,
                            fontWeight: '700',
...
export default ExchangeLibraryLayout;
