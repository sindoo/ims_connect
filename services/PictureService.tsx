...
class PictureService {
    static getPictureData = async (selectedChildId: number, userId: number) => {
        const imageListRequest: any = await getRequest(
            '',
            `/extra/images/enfant/${selectedChildId}/${userId}`,
        );
    ...
    static deletePicture = async (pictureIdList: any) => {
